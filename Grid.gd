...
func _ready():
	...
	new_player.set_position(map_to_world(Vector2(4,4)) + tile_offset)  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
	...
	for pos in positions:
		...
		new_obstacle.set_position(map_to_world(pos) + tile_offset)  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
...
func update_child_position(pos, direction, type):  #-- NOTE: Automatically converted by Godot 2 to 3 converter, please review
